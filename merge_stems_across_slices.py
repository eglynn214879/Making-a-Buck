...
# drift / matching
NN_RADIUS_M = 0.60        # max distance to consider a match when estimating slice drift
MATCH_ITERS = 2           # ICP-like refinement steps

# clustering (after drift correction)
CLUSTER_EPS_M       = 0.25  # points within this are the same stem (≈ 25 cm)
